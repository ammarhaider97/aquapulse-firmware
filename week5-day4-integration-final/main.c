...
// =====================================================
// No mock endpoint URL was provided by the internship -- placeholder
// kept as-is. http_post_json() will print "[HTTP] POST failed: ..."
// until this is replaced with a real URL; that's expected for now.
...
// =====================================================
// FINAL task -- replaces http_test_task (Day 3). Runs every 10s: takes
// a sensor snapshot, validates + builds JSON, POSTs it if WiFi is up.
// Also runs the fault-injection demo when TEST_FAULT_INJECTION is 1.
...
void app_main(void)
{
    ...
    // NEW (Week 5 - Day 4): final integrated JSON + WiFi + HTTP pipeline,
    // replacing Day 3's http_test_task.
